...
# Portage.
MY_PV=$(ver_rs 1- '')
SRC_URI="Setup_EmbeddedStudio_v${MY_PV}_linux_x64.tar.gz"

# Source directory; the dir where the sources can be found (automatically
# unpacked) inside ${WORKDIR}.  The default value for S is ${WORKDIR}/${P}
# If you don't need to change it, leave the S= line out of the ebuild
# to keep it tidy.
S="${WORKDIR}/segger_embedded_studio_v${MY_PV}_linux_x64"
...
src_install() {
    dodir /opt/embeddedstudio
    
    ${S}/install_segger_embedded_studio --accept-license \
	--copy-files-to ${D}/opt/embeddedstudio \
	--verbose
