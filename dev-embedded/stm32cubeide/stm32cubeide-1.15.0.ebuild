...
DESCRIPTION="STM32CubeIDE is an all-in-one multi-OS development tool."
...
# Portage.
SRC_URI="en.st-stm32cubeide_1.15.0_20695_20240315_1429_amd64.sh.zip"
...
PATCHES=(
    "${FILESDIR}/001_skip_license.diff"
    "${FILESDIR}/002-fix-md5.diff"
    "${FILESDIR}/003-add-debugging.diff"
)
...
src_install() {
    ...
    chmod +x ${S}/st-stm32cubeide_1.15.0_20695_20240315_1429_amd64.sh
    export TMPDIR=${T}
    bash -x ${S}/st-stm32cubeide_1.15.0_20695_20240315_1429_amd64.sh \
	--nochown \
	--noprogress \
	--nox11
