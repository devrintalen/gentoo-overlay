EAPI=8
DESCRIPTION="Implementation of xprintidle for Wayland environments"
HOMEPAGE="https://github.com/devrintalen/wprintidle-c"
SRC_URI="https://github.com/devrintalen/wprintidle-c/archive/refs/tags/v${PV}.tar.gz"
#S="${WORKDIR}/${P}"
LICENSE="GPL-3+"
SLOT="0"
KEYWORDS="~amd64"
...
# a dependency.
RDEPEND=">=dev-libs/wayland-1.24.0"
